...
<!-- 푸터 수정 후 -->
    ...
    <script src="${path}/resources/bootstrap-5/html/js/datepicker-category.js"> </script>
    <!-- Price Slider-->
    <script src="${path}/resources/bootstrap-5/html/vendor/nouislider/nouislider.min.js"></script>
    <script>
