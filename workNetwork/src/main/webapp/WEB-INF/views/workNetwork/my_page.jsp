		...
		<div class="row g-4">
				...
				<div class="card border h-100">
					...
					<div class="card-body">
						<div class="d-sm-flex justify-content-sm-between align-items-center mb-4">
							...
							<div class="d-flex align-items-center">
								...
								<!-- Info -->
								<div class="ms-3">
									<h5 class="mb-0">Youngju Kim</h5>
									<p class="mb-0 small" style="font-size: 15px;">분당서울대병원 영상의학과</p>
								</div>
							</div>
							<!-- Tags -->
							<div class="d-flex mt-2 mt-sm-0">
								<!-- bg-danger == 빨간색 + bg-dribbble == 핑크색 + bg-facebook == 현대오일뱅크색 -->
								<h6 class="bg-facebook py-2 px-3 text-white rounded" style="font-size: 18px;">비정규근로자</h6>
								<h6 class="bg-info py-2 px-3 text-white rounded ms-2" style="font-size: 18px;">전문, 과학 및 기술 서비스업</h6>
							</div>
						</div>
                  ...
                  <!-- 직급 -->
									<li class="list-group-item">
										...
										<span class="h6 mb-0" style="font-size: 18px;">신입</span>
									</li>
                  <!-- Full Name -->
									<li class="list-group-item">
										<span style="font-size: 18px;">Full Name:</span>
										<span class="h6 mb-0" style="font-size: 18px;">김영주</span>
									</li>
                  <!-- User Name -->
									<li class="list-group-item">
										<span style="font-size: 18px;">User Name:</span>
										<span class="h6 mb-0" style="font-size: 18px;">BD_kyj</span>
									</li>
								</ul>
							</div>
                  ...
                  <!-- Email ID -->
									<li class="list-group-item">
										...
										<span class="h6 mb-0" style="font-size: 18px;">youngjukim@bd.team3.com</span>
									</li>
                  <!-- Mobile Number -->
									<li class="list-group-item">
										<span style="font-size: 18px;">Mobile Number:</span>
										<span class="h6 mb-0" style="font-size: 18px;">010-7720-0102</span>
									</li>
                  <!-- Joining Date -->
									<li class="list-group-item">
										<span style="font-size: 18px;">Joining Date:</span>
										<span class="h6 mb-0" style="font-size: 18px;">2023-05-01</span>
									</li>
								</ul>
							</div>
						</div>
			...
			<div class="col-md-6 col-lg-4" style="margin-bottom: 30px;">
				...
				<div class="card border h-100" style="background-color: rgb(242, 95, 95);">
					...
					<div id="conf_id" v="hufs2017"></div>
					<div id="conf_pwd" v="0001"></div>
					<script>
					...
					<div class="card-body p-3" style="background-color: white;">
						...
						<div class="row">
							...
							<div class="col-12">
								<div class="d-flex align-items-center position-relative">
									<div class="avatar avatar-lg flex-shrink-0">
										<img class="avatar-img rounded-2" src="${path}/resources/img/holiday.png" style="width: 55px; height: 55px;" alt="avatar">
									</div>
									<div class="ms-3">
										<a href="#" class="h6 stretched-link" style="font-size: 20px;">주간 연장 근무 시간</a>
									</div>
								</div>
							</div>
							...
							<!-- Comment item -->
							<div class="col-12">
								<div class="d-flex align-items-center position-relative" style="margin-top: 10px;">
									<div class="avatar avatar-lg flex-shrink-0">
										<img class="avatar-img rounded-2" src="${path}/resources/img/person.png" style="width: 55px; height: 55px;" alt="avatar">
									</div>
									<div class="ms-3" style="box-shadow: 0 0 0 12;">
										<a href="#" class="h6 stretched-link" style="font-size: 20px;">회원정보 수정 및 탈퇴</a>
									</div>
								</div>
							</div>
				...
				<div class="card border" style="margin-bottom: 10px; height: 450px; border: 3px solid rgb(68, 116, 65); border-bottom-left-radius: 0px; border-bottom-right-radius: 0px;  box-shadow: 0 0 3px rgb(153, 153, 153);">
					...
					const ctx = document.getElementById('myChart');
						...
						data: {
							...
							datasets: [{
							label: '월별 근무 시간',
							data: [12, 19, 3, 5, 2, 3, 6,14,15,16,12,3],
							borderWidth: 3
							}]
						},
						options: {
