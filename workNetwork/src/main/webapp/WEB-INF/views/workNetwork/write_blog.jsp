        ...
        <form method="post" action="${path}/workNetwork/writesuccess">
          <div class="row form-block">
            ...
            <div class="col-lg-7 ms-auto">
              ...
              <div class="mb-5">
                <label class="form-label" for="form_availability">직종</label>
                <textarea class="form-control" name="department" id="form_availability" rows="1" aria-describedby="availabilityHelp"></textarea><small class="form-text text-muted mt-2" id="availabilityHelp">본인이 속한 직종을 선택해주세요.    </small>
              </div>
              <div class="mb-5">
