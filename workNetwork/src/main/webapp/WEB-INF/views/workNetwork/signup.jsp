        ...
        <div class="col-md-8 col-lg-6 col-xl-5 d-flex align-items-center">
          <div class="w-100 py-5 px-md-5 px-xxl-6 position-relative">
            ...
            <form class="form-validate">
              ...
              <div class="mb-4">
                ...
                <div style="border: 1px solid #d2d2d2; border-radius: .45em;">
                  <select class="selectpicker form-control" id="job" name="job" title="직종 선택" data-style="btn-form-control">
                    <option value="jejo">제조업</option>
                    <option value="gunsul">건설업</option>
                    <option value="domesome">도매 및 소매업</option>
                    <option value="changgo">운수 및 창고업</option>
                    <option value="yori">숙박 및 음식업</option>
                    <option value="jungbo">정보통신업</option>
                    <option value="money">금융 및 보험업</option>
                    <option value="science">전문, 과학 및 기술 서비스업</option>
                    <option value="jiwon">사업시설 관리, 사업 지원 및 임대 서비스업</option>
                    <option value="gonggong">공공 행정, 국방 및 사회보장 행정</option>
                    <option value="study">교육 서비스업</option>
                    <option value="bogun">보건업 및 사회복지 서비스업</option>
              ...
              <div class="d-grid">
                <button class="btn btn-lg btn-primary" style="background-color: #FEE500; border: none; border: none; height: 65px; font-size: 21px; margin-bottom: 15px; color: #000000"><img src="${path}/resources/img/kakao_icon.png" style="height: 100%;"/> <span class="d-none d-sm-inline">카카오 회원가입</span></button>
              </div>
              <hr class="my-4">
