...
<!-- 댓글 달기 -->                    
                    <form class="form" id="comment-form">
                      <div class="row">
                        <div class="col-md-6">                           
                          <div class="mb-4">
                            <label class="form-label" for="reply_name">이름 <span class="required">*</span></label>
                            <input class="form-control" id="reply_name" type="text" name="reply_name">
                          </div>
                        </div>
                        <div class="mb-4">
                    	...
                    	<script type="text/javascript">
	                    	function movePage(pageUrl){
	                    		var reply_name = document.getElementById('reply_name').value;
	                    		var reply_content = document.getElementById('reply_content').value;
	                    		var updatedUrl = pageUrl + '&reply_name=' + reply_name + '&reply_content=' + reply_content;
