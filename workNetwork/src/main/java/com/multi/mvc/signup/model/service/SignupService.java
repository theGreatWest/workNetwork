...
public class SignupService {
    ...
    public boolean insertMember(Map<String, String> param, HttpServletRequest request){
        ...
        String formattedDateWithDots = formattedDate.replace("-", ".");

        System.out.println("Current date is " + formattedDateWithDots);


        if (loginMapper.login(id,password)==null){
            System.out.println("check");
            mapper.insertMember(member_no,id,password,name,email,phoneNumber);
