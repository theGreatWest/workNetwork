...
public interface SignupMapper {
    void insertMember(@Param("member_no") int member_no, @Param("id") String id, @Param("password") String password, @Param("name") String name, @Param("email") String email, @Param("phone_number") String phoneNumber);
